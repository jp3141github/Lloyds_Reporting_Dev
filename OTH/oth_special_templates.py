"""
PRA/BoE Other Templates - Special Regulatory Returns
=====================================================
Non-IR regulatory templates for specialist reporting.

Templates:
- MALIR: Matching Adjustment Life Insurance Return (6 sub-tables)
